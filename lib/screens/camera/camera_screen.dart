...
//   late Future<void> _initializeControllerFuture;
//   bool _isRecording = false;
//   bool _shouldKeepRecording = false;
//   String? _recordedPath;
...
//   @override
//   void dispose() {
//     _shouldKeepRecording = false;
//     _controller.dispose();
//     super.dispose();
//   }

//   Future<void> _startRecording() async {
//     if (_isRecording || _shouldKeepRecording) return;

//     _shouldKeepRecording = true;
//     _recordNextClip();
//   }

//   Future<void> _recordNextClip() async {
//     if (!_shouldKeepRecording) return;
...
//     try {
//       await _initializeControllerFuture;
//       if (_isRecording || _shouldKeepRecording) {
//         await _stopRecording(context);
//       } else {
//         await _startRecording();
//       }
...
//                       return FloatingActionButton(
//                         backgroundColor:
//                             _isRecording || _shouldKeepRecording
//                                 ? Colors.red
//                                 : Colors.black,
//                         onPressed: isUploading
//                             ? null
